...
date: "2026-01-04"
tags: ["psychology", "time-perception", "memory", "life-lessons", "novelty", "habits"]
author: "Nishant Khurana"
description: "Understanding why time seems to accelerate with age and how novelty and memorable experiences can slow down your perception of time."
---
...
### The Time Perception Mechanism

```
     NOVEL EXPERIENCES                    ROUTINE EXPERIENCES
     ─────────────────                    ──────────────────
            │                                     │
            ▼                                     ▼
    ┌───────────────┐                    ┌───────────────┐
    │ Brain Records │                    │  Brain Saves  │
    │   Actively    │                    │    Energy     │
    └───────┬───────┘                    └───────┬───────┘
            │                                     │
            ▼                                     ▼
    ...
    └───────┬───────┘                    └───────┬───────┘
            ...
            ▼                                     ▼
    ┌───────────────┐                    ┌───────────────┐
    │  Time Feels   │                    │  Time Feels   │
    │   EXPANDED    │                    │  COMPRESSED   │
    └───────────────┘                    └───────────────┘

    YOUTH                                ADULTHOOD
    (Everything novel)                   (Everything routine)
...
---
Imported from dg-gatsby: `/Users/skypawalker/Dev/dg-gatsby/content/garden/modern-wisdom/Time-Perception.mdx`

<!-- term-concept-links:start -->
## Term-derived concept links

- [[Focus and Attention]] — term-derived match: score 18; terms: attention, time
- [[Gratitude and Presence]] — term-derived match: score 8; terms: present, life, slow
- [[Learning and Advice]] — term-derived match: score 4; terms: wisdom, experience
- [[Discipline and Consistency]] — term-derived match: score 3; terms: habits, routine
