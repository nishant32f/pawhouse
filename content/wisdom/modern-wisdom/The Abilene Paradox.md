...
date: "2025-01-07"
tags: ["psychology", "group-dynamics", "decision-making", "communication", "paradoxes"]
author: "Nishant Khurana"
description: "Understanding how groups can collectively decide on a course of action that none of the individual members actually want, and how to break free from this communication trap."
---
...
```
      ┌─────────────────────────────────────────┐
      │    Someone suggests an action           │
      └──────────────┬──────────────────────────┘
                     │
                     ▼
      ┌─────────────────────────────────────────┐
      │  Everyone assumes others want it        │
      │      (False Consensus)                  │
      └──────────────┬──────────────────────────┘
                     │
                     ▼
      ┌─────────────────────────────────────────┐
      │  Fear of being the troublemaker         │
      │      → Stay Silent                      │
      └──────────────┬──────────────────────────┘
                     │
                     ▼
