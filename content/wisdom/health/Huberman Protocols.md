...
Dr. Andrew Huberman is a neuroscientist and tenured Professor in the Department of Neurobiology at the Stanford University School of Medicine. He is the host of the Huberman Lab podcast, where he discusses neuroscience and science-based tools for everyday life.

**Resources:**
- **Website:** [hubermanlab.com](https://hubermanlab.com)
- **Podcast:** Huberman Lab (available on all podcast platforms)
- **Book:** "Protocols: An Operating Manual for the Human Body" (2024)
...
| Time/Action | Protocol | Priority | Notes |
|-------------|----------|----------|-------|
| **Upon waking** | 5-10 min sunlight (even if cloudy) | 🔴 #1 MOST IMPORTANT | Sets circadian clock |
| **10pm-4am** | Avoid bright lights (especially overhead) | 🔴 #2 MOST IMPORTANT | Red/firelight OK, low lights less harmful |
| **8-10 hrs before bed** | Stop caffeine | High | Disrupts sleep |
| **Near bedtime** | Avoid alcohol | Medium | Disrupts sleep quality |
| **Sleep environment** | Cool & dark | High | Optimal conditions |
| **Schedule** | Limit variation | High | Consistency > total hours |
| **Naps** | <90 minutes | ✅ OK | Won't disrupt cycle |
| **Jet lag** | Shift clock gradually | As needed | Plan ahead |

**Supplements** (less important than behavioral protocols):
- ✅ Apigenin (chamomile tea) or Theanine - if trouble falling asleep
- ✅ NSDR - for insomnia
- ❌ Melatonin - Huberman does NOT recommend
- ❌ Magnesium - limited evidence except niche cases
